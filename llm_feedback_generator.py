...
## Few-shot例（できるだけ250文字に近い長さで）

DiCE提案が1つの場合: 「仕事」→「睡眠」(改善5.2点)
出力: 「今日は仕事でストレスを感じていましたね。長時間の集中作業は心身に負担がかかりますよね。仕事の合間に15分程度の睡眠を取り入れてみるのはいかがでしょうか？短い休息でも、頭がすっきりして気持ちをリフレッシュできるかもしれません。無理せず、自分のペースを大切にしてくださいね。明日もあなたらしく過ごせますように。」

DiCE提案が複数ある場合: 「授業・学内の活動」→「インターネット動画」(改善4.3点)、「仕事」→「睡眠」(改善3.8点)
出力: 「授業・学内の活動でストレスが高かったようですね。長時間の集中は疲れますよね。授業の合間にインターネット動画を視聴してみるのはいかがでしょうか？気分転換になるかもしれません。また、仕事の後には少し睡眠を取り入れてみるのも良いかもしれませんね。短い休息でもリフレッシュできます。自分を大切にして、無理のないペースで過ごしてくださいね。」
