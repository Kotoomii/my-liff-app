...
出力: 「今日は仕事でストレスを感じていましたね。仕事の合間に15分程度の睡眠を取り入れてみるのはいかがでしょうか？」

DiCE提案: 「勉強」→「運動」(改善3.8点)の場合
出力: 「勉強でストレスを感じていましたね。勉強の合間に軽い運動を取り入れてみるのはいかがでしょうか？」

## 出力形式（250文字以内厳守）
1. 高ストレス活動の確認（50文字）
2. DiCE提案された具体的な活動を取り入れる提案（170文字）
3. 締めの言葉（30文字）
"""
